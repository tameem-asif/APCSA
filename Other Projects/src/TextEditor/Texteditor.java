...
{
            MenuBar mbar;
            Menu file,edit,format,font,font1,font2,avscript;
...
font2=new Menu("Size");
avscript = new Menu("Audio Video Script");
...
avscript.add(av1=new MenuItem("Scene Heading"));
avscript.add(av2=new MenuItem("Shot"));
avscript.add(av3=new MenuItem("Character"));
avscript.add(av4=new MenuItem("Dialouge"));
avscript.add(av5=new MenuItem("Parenthetical"));
...
av4.addActionListener(this);
av5.addActionListener(this);
